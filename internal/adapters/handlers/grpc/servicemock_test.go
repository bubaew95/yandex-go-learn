...
// MockShortenerService is an autogenerated mockData type for the ShortenerService type
type MockShortenerService struct {
	mock.Mock
}

// DeleteUserURLS provides a mockData function with given fields: ctx, items
...
// GenerateURL provides a mockData function with given fields: ctx, url, randomStringLength
...
// GetURLByID provides a mockData function with given fields: ctx, id
...
// GetURLByOriginalURL provides a mockData function with given fields: ctx, originalURL
...
// GetURLSByUserID provides a mockData function with given fields: ctx, userID
...
// InsertURLs provides a mockData function with given fields: ctx, urls
...
// Ping provides a mockData function with given fields: ctx
...
// RandStringBytes provides a mockData function with given fields: n
...
// ScheduleURLDeletion provides a mockData function with given fields: ctx, items
func (_m *MockShortenerService) ScheduleURLDeletion(ctx context.Context, items []model.URLToDelete) {
	_m.Called(ctx, items)
}

// Stats provides a mockData function with given fields: ctx
...
// NewMockShortenerService creates a new instance of MockShortenerService. It also registers a testing interface on the mockData and a cleanup function to assert the mocks expectations.
